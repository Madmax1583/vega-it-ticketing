...
def render_home_page(
    ...
    **kwargs: Any,
    ...
    st.markdown(
        f"""<div style="padding:18px;border-radius:16px;border:1px solid rgba(96,165,250,.24);
        background:linear-gradient(135deg,rgba(59,130,246,.18),rgba(15,23,42,.96));margin-bottom:16px;">
        <div style="color:#94a3b8;font-size:12px;text-transform:uppercase;">Welcome</div>
